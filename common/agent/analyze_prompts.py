TASK_PROMPT = """\
You are a Principal Software Engineer tasked with writing a detailed code review. \
Generate the best review possible for the user's request and the initial outline. \
